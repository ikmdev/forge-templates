...
/**
 * A binding for the pattern ${patternName}
 */
public interface ${className} {
     ...
     *
     * @return int representing the index of the field in the pattern.
     */
    ...
    interface Version {
         ...
         * @return int representing the index of the field in the pattern.
         */
        static int ${toCamelCase(textOf(fieldMeaning, defaultLanguageCalc))}() {
